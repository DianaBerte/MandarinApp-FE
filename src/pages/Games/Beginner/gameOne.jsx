            ...
            <div className="container-div">
                ...
                <div className="game-container">
                    ...
                    <div className="right-column">
                            {currentGame.answers && currentGame.answers.length > 0 //checking if the object "currentGame" has a property called "answers"č if so, it checks if "answers" has any elements
